...
public:
    ...
    UdpDoubleSernder(const std::string& remoteHost,
                     uint16_t remotePort,
                     uint16_t localPort,
                     int maxDoubles,
    ...
    // Move-only
    UdpDoubleSernder(const UdpDoubleSernder&) = delete;
    UdpDoubleSernder& operator=(const UdpDoubleSernder&) = delete;

    UdpDoubleSernder(UdpDoubleSernder&& other) noexcept;
    UdpDoubleSernder& operator=(UdpDoubleSernder&& other) noexcept;
...
private:
    bool   isOpen_() const;
    void   closeSock_();
    void   moveFrom_(UdpDoubleSernder&& o) noexcept;
